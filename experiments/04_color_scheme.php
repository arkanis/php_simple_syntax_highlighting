...
<style>
	...
	/*
		land mark A, B, C  → landmark_a1  lma1 lma2 lmb1
		variation A, B, C  → variation_a1 va vb1 vb2
		backdrop A, B      → backdrop_a   ba bb
	*/
</style>

<pre data-s=<?= $code_examples[21][0] ?>><?= highlight_31_nested_groups($code_examples[21][1], $code_examples[21][0], debug: true) ?></pre>
<hr>
...
<pre data-s=<?= $language ?>><?= highlight_31_nested_groups($code, $language) ?></pre>
<hr>
<?php endforeach ?>

<pre data-s=html><?= highlight_31_nested_groups(file_get_contents("03_benchmarking.php"), "html") ?></pre>
<hr>
